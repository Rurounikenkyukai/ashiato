...
Event.create(event_day: "20190104", event_title:"サンプルイベント２", event_image_id: "4", event_prefectures: "東京都", event_city:"渋谷区",event_address: "東京都渋谷区神南")
Event.create(event_day: "20190104", event_title:"サンプルイベント３", event_image_id: "5", event_prefectures: "東京都", event_city:"渋谷区",event_address: "東京都渋谷区神南")
Event.create(event_day: "20190104", event_title:"サンプルイベント４", event_image_id: "6", event_prefectures: "東京都", event_city:"渋谷区",event_address: "東京都渋谷区神南")
Event.create(event_day: "20190104", event_title:"サンプルイベント５", event_image_id: "7", event_prefectures: "東京都", event_city:"渋谷区",event_address: "東京都渋谷区神南")
Event.create(event_day: "20190104", event_title:"サンプルイベント６", event_image_id: "8", event_prefectures: "東京都", event_city:"港区",event_address: "東京都港区六本木")
Event.create(event_day: "20190104", event_title:"サンプルイベント７", event_image_id: "9", event_prefectures: "東京都", event_city:"港区",event_address: "東京都港区六本木")
Event.create(event_day: "20190105", event_title:"サンプルイベント８", event_image_id: "10", event_prefectures: "東京都", event_city:"港区",event_address: "東京都港区六本木")
Event.create(event_day: "20190105", event_title:"サンプルイベント９", event_image_id: "11", event_prefectures: "東京都", event_city:"港区",event_address: "東京都港区六本木")
Cd.create(cd_title: "裸眼のメンターさん大体イケメン",cd_image_id: "1", cd_genre: "HipHop", cd_price:  2500, cd_stock: 25, cd_label: "チーム開発")
Cd.create(cd_title: "ラーメンとライス一緒に食べるやつは邪道",cd_image_id: "2", cd_genre: "HipHop", cd_price:  600, cd_stock: 30, cd_label: "チーム開発")
Cd.create(cd_title: "メロンに生ハム乗せて食べるやつは邪道",cd_image_id: "3", cd_genre: "HipHop", cd_price:  6000, cd_stock: 20, cd_label: "チーム開発")
Cd.create(cd_title: "スイカに塩かけて食べるやつは邪道",cd_image_id: "4", cd_genre: "HipHop", cd_price:  6880, cd_stock: 30, cd_label: "チーム開発")
Cd.create(cd_title: "ケニアに帰りたい",cd_image_id: "5", cd_genre: "HipHop", cd_price:  880, cd_stock: 10, cd_label: "チーム開発")
Cd.create(cd_title: "僕の頭はお花畑",cd_image_id: "6", cd_genre: "HipHop", cd_price:  9000, cd_stock: 15, cd_label: "チーム開発")
Cd.create(cd_title: "ドラえもんを嫁に下さい",cd_image_id: "7", cd_genre: "レゲエ", cd_price:  900, cd_stock: 5, cd_label: "チーム開発")
Cd.create(cd_title: "僕が小便したら、虹がかかる",cd_image_id: "8", cd_genre: "レゲエ", cd_price:  1900, cd_stock: 30, cd_label: "チーム開発")
Cd.create(cd_title: "「rails db:migrate」で大体のエラーなおる。",cd_image_id: "9", cd_genre: "レゲエ", cd_price:  5500, cd_stock: 3, cd_label: "私は貝になりたくない")
Cd.create(cd_title: "自慢なんですが僕、鼻毛出たことありません",cd_image_id: "10", cd_genre: "レゲエ", cd_price:  1300, cd_stock: 10, cd_label: "私は貝になりたくない")
